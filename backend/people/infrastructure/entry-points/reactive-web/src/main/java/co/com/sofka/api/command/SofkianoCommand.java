...
import co.com.sofka.usecase.command.SofkianoCommandUseCase;
...
public class SofkianoCommand extends DomainMapper<Sofkiano, SofkianoDTO> {
    ...
    public Mono<SofkianoDTO> saveSofkiano(@RequestBody SofkianoDTO sofkianoDTO) {
    ...
    protected Sofkiano dtoToDomain(SofkianoDTO dtoObject) {
        return super.dtoToDomain(dtoObject)
                .toBuilder()
                .stacks(this.mapListObject(dtoObject.getSkills(), Stack.class))
                .build();
    }
}
